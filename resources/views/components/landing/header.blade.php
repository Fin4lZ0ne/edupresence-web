<div class="fixed w-full z-50 shadow transition-colors text-white" id="header">
    <div class="container max-w-7xl mx-auto bg-transparent p-5">
        <div class="flex justify-between items-center">
            <div class="w-full">
                <img class="w20 logo-light" src="{{ asset('img/logo-light3.svg') }}" alt="{{ $alt }}">
                <img class="logo-dark hidden" src="{{ asset('img/logo-dark1.png') }}" alt="{{ $alt }}">
            </div>
